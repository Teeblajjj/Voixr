...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // pricing
  {
    ...
    'waae3xc0': {
      'en':
          'From quick voiceovers to full podcast productions \nVoixr scales with your voice journey. Start small or go big — every word counts.',
      'fr': '',
      'hi': '',
      'sw': '',
      'zh_Hans': '',
    ...
    '84djomla': {
      'en':
          'Get creative with 20,000 credits to use across Voixr’s premium voice tools. get unlimited credit top up access.',
      'fr': '',
      'hi': '',
      'sw': '',
      'zh_Hans': '',
    ...
    '240r49o9': {
      'en':
          'All pass are subject to our Terms and Conditions.\nCredits expire at the end of each stated period — one month pass credits reset after 30 days, and one year pass credits reset after 12 months. Your pass will not auto-renew. Renewal is manual.',
      'fr': '',
      'hi': '',
      'sw': '',
      'zh_Hans': '',
  ...
  // emptylist
  {
    ...
    'qsq2q6kl': {
      'en': 'it looks empty here. create some contents to get started!',
      'fr': '',
      'hi': '',
      'sw': '',
      'zh_Hans': '',
