...
import 'podcastchoicev_model.dart';
export 'podcastchoicev_model.dart';

class PodcastchoicevWidget extends StatefulWidget {
  const PodcastchoicevWidget({
    super.key,
    this.voiceid,
    this.voicename,
    this.usecase,
  ...
  @override
  State<PodcastchoicevWidget> createState() => _PodcastchoicevWidgetState();
}

class _PodcastchoicevWidgetState extends State<PodcastchoicevWidget> {
  late PodcastchoicevModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PodcastchoicevModel());
