...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC50390);
  late Color secondary = const Color(0xFFBD148F);
  late Color tertiary = const Color(0xFFACC420);
  late Color alternate = const Color(0xFFEBECED);
  late Color primaryText = const Color(0xFF121212);
  late Color secondaryText = const Color(0xFF373636);
  late Color primaryBackground = const Color(0xFFF0F1F2);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C2797FF);
  late Color accent2 = const Color(0x11BEB5CD);
  late Color accent3 = const Color(0x40C122FA);
  ...
  late Color button = const Color(0xFF282A2D);
  late Color customColor1 = const Color(0xEDFFFFFF);
  late Color customColor2 = const Color(0x1FFFFFFF);
  late Color customColor3 = const Color(0xE8F0F1F2);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFBD148F);
  late Color tertiary = const Color(0xFFACC420);
  late Color alternate = const Color(0xFF242628);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFB9BDC3);
  late Color primaryBackground = const Color(0xFF000000);
  late Color secondaryBackground = const Color(0xFF161618);
  late Color accent1 = const Color(0x4C2797FF);
  late Color accent2 = const Color(0x11161418);
  late Color accent3 = const Color(0x40C122FA);
  ...
  late Color button = const Color(0xFFFCF7F7);
  late Color customColor1 = const Color(0xFF19191A);
  late Color customColor2 = const Color(0x09101010);
  late Color customColor3 = const Color(0xE6101010);
}
