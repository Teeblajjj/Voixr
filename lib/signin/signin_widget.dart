                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'kqydpfjl' /* Let's get on by filling out th... */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'bwvzxsbn' /* Don't have an account?   */,
                                            ),
                                            style: TextStyle(
                                              color: Color(0xFFD5D1D1),
                                            ),
