...
///
///
class PodplaynewWidget extends StatefulWidget {
  const PodplaynewWidget({
    super.key,
  ...
  static String routeName = 'podplaynew';
  static String routePath = 'podplaynew';

  @override
  State<PodplaynewWidget> createState() => _PodplaynewWidgetState();
}

class _PodplaynewWidgetState extends State<PodplaynewWidget> {
  late PodplaynewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PodplaynewModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<PodcastsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final podplaynewPodcastsRecord = snapshot.data!;
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      valueOrDefault<String>(
                                                        podplaynewPodcastsRecord
                                                            .topic,
                                                        'Re-define the language data from earlier',
                                                      ).maybeHandleOverflow(
                                                        maxChars: 45,
                                                      ),
                                                      textAlign:
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          await downloadFile(
                                            filename:
                                                'Voixr Audio${random_data.randomString(
                                              2,
                                              7,
                                              true,
                                              true,
