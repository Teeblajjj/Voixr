...
import 'transcripthistrory_model.dart';
export 'transcripthistrory_model.dart';

class TranscripthistroryWidget extends StatefulWidget {
  const TranscripthistroryWidget({super.key});

  static String routeName = 'transcripthistrory';
  static String routePath = 'transcripthistrory';

  @override
  State<TranscripthistroryWidget> createState() =>
      _TranscripthistroryWidgetState();
}

class _TranscripthistroryWidgetState extends State<TranscripthistroryWidget> {
  late TranscripthistroryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranscripthistroryModel());
