...
class Voice2compWidget extends StatefulWidget {
  const Voice2compWidget({
    super.key,
    this.name,
    this.usecase,
    this.link,
  ...
  @override
  State<Voice2compWidget> createState() => _Voice2compWidgetState();
}

class _Voice2compWidgetState extends State<Voice2compWidget> {
  late Voice2compModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Voice2compModel());
  }
