...
class _LoadingScreenWidgetState extends State<LoadingScreenWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.oncreentext = 'Voicing Magic...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Tuning the vibes...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Mastering audio...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 1000));
      _model.oncreentext = 'Warming up the mic...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Crafting your sound...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Loading rich sound...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Mixing sweet tones...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      ...
      _model.oncreentext = 'Audio on the way...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 300));
      _model.oncreentext = 'Tuning the vibes...';
      safeSetState(() {});
      ...
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Loading good vibes...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Mixing sweet tones...';
      safeSetState(() {});
      ...
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Loading good fx...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Mixing sweet tones...';
      safeSetState(() {});
      ...
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Loading good EQ...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Mixing sweet tones...';
      safeSetState(() {});
      ...
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Prepping your Sound...';
      safeSetState(() {});
      await Future.delayed(const Duration(milliseconds: 600));
      _model.oncreentext = 'Audio on the way...';
      safeSetState(() {});
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'gvpw734r' /* Generation takes about 30-60 s... */,
                                  ),
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'za6263p8' /* Your Audio will be ready for d... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
