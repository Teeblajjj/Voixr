...
/// Create a page for audio library whicjh will carry a tab to swith btween
                ...
                Align(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      ...
                      Tab(
                        text: FFLocalizations.of(context).getText(
                          'wcfgpjxp' /* Voice overs */,
                        ),
                      ),
                      Tab(
                        text: FFLocalizations.of(context).getText(
                          'en30l9gt' /* Transcriptions */,
                        ),
                      ),
                    ],
                                  ...
                                  children: [
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                await _model.bosaved?.animateTo(
                                                  _model.bosaved!.position
                                                      .maxScrollExtent,
                                                  duration: Duration(
                                                      milliseconds: 200),
                                                  curve: Curves.ease,
                                    ...
                                    StreamBuilder<List<PodcastsRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<PodcastsRecord>
                                            bosavedPodcastsRecordList =
                                            snapshot.data!;
                                        if (bosavedPodcastsRecordList.isEmpty) {
                                          return Center(
                                            child: Container(
                                              width: 400.0,
                                              height: 200.0,
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                valueOrDefault<
                                                                  ...
                                                                  bosavedPodcastsRecord
                                                                      .topic,
                                                                  'An in-app purchase allows customers',
                                                                ).maybeHandleOverflow(
                                                                  maxChars: 15,
                                                                  replacement:
                                                                      '…',
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            await _model.scrollcom?.animateTo(
                                              _model.scrollcom!.position
                                                  .maxScrollExtent,
                                              duration:
                                    ...
                                    StreamBuilder<List<PodcastsRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<PodcastsRecord>
                                            lisofmyPodcastsRecordList =
                                            snapshot.data!;
                                        if (lisofmyPodcastsRecordList.isEmpty) {
                                          return Center(
                                            child: Container(
                                              width: 450.0,
                                              height: 300.0,
                                        ...
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          children: List.generate(
                                              lisofmyPodcastsRecordList.length,
                                              (lisofmyIndex) {
                                            final lisofmyPodcastsRecord =
                                                lisofmyPodcastsRecordList[
                                                    lisofmyIndex];
                                            return Padding(
                                              padding: EdgeInsetsDirectional
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  valueOrDefault<
                                                                      String>(
                                                                    '${lisofmyPodcastsRecord.byname} •  ${lisofmyPodcastsRecord.language}',
                                                                    'Tony • English',
                                                                  ),
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                            ...
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          onChanged: (_) =>
                                            ...
                                            () async {
                                              await querySpeechDataRecordOnce()
                                                  .then(
                                                    (records) => _model
                                                            .simpleSearchResults =
                                                        TextSearch(
                                          ...
                                          decoration: InputDecoration(
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'uc1vqhr0' /* Search your voice library... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                    ...
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        context
                                            .pushNamed(VoicesWidget.routeName);
                                      },
                                    ),
                                  ].divide(SizedBox(width: 8.0)),
                                ),
                                          ...
                                          children: List.generate(search.length,
                                            ...
                                            return Visibility(
                                              ...
                                              .divide(
                                                ...
                                                filterFn: (searchIndex) {
                                                  final searchItem =
                                                      search[searchIndex];
                                                  return searchItem.userId ==
                                                      currentUserReference?.id;
                                                },
                                              )
                                              .addToStart(
                              ...
                              if (_model.textController2.text == null ||
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 0.0),
                                  child: StreamBuilder<List<SpeechDataRecord>>(
                                    stream: FFAppState().history(
                                      requestFn: () => querySpeechDataRecord(
                                        queryBuilder: (speechDataRecord) =>
                                            speechDataRecord
                                                .where(
                                                  'user_id',
                                                  isEqualTo:
                                      ...
                                      return SingleChildScrollView(
                                        ...
                                        child: Column(
                                          ...
                                          children: List.generate(
                                                  columnSpeechDataRecordList
                                                      .length, (columnIndex) {
                                            final columnSpeechDataRecord =
                                                columnSpeechDataRecordList[
                                                    columnIndex];
                                            return Visibility(
                                              visible: columnSpeechDataRecord
                                                      .userId ==
                                                  currentUserReference?.id,
                                              child: InkWell(
                                                splashColor: Colors.transparent,
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'fxuqgx1h' /* Search transcriptions... */,
                                    ),
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'v8yon0jg' /* Recent Transcriptions */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .titleLarge
                                              .override(
                                    ...
                                    StreamBuilder<List<TranscriptionsRecord>>(
                                      stream: FFAppState().transcrip(
                                        requestFn: () =>
                                            queryTranscriptionsRecord(
                                          queryBuilder:
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<TranscriptionsRecord>
                                            listViewTranscriptionsRecordList =
                                            snapshot.data!;
                                        if (listViewTranscriptionsRecordList
                                            .isEmpty) {
